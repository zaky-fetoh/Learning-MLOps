...
function postInteraction() {
	...
	if(articleWrapper) {
		...
		var articleSidebar = articleSidebar.getBoundingClientRect();
		var postYTrigger = articleSidebar.height + 160;

		var scrollTop = window.pageYOffset || document.documentElement.scrollTop;

		if(scrollTop > postYTrigger) {
			articleWrapper.classList.add('is-focused');
		} else {
			articleWrapper.classList.remove('is-focused');
		}
	}
}
